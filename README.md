...
Project of [Getting and Cleaning Data course on Coursera](https://class.coursera.org/getdata-015/), June 2015 edition.
...
The data linked to from the course website represent data collected from the accelerometers from the Samsung Galaxy Ssmartphone. A full description is available at the site where the data was obtained: 
...
1. clone this repository: `git clone https://github.com/medinmtl/GettingCleaningData`
...
In the repository root directory you find the file `tidy_dataset_avg_each_var_each_activity_each_subject.txt` with the tidy data set.
